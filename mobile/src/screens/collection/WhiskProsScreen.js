...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: spacing.lg, paddingTop: spacing.lg, paddingBottom: spacing.sm, alignItems: 'flex-start' },
  title: { ...typography.h2, marginBottom: 4, textAlign: 'left' },
  subtitle: { color: colors.textSecondary, fontSize: 13, textAlign: 'left' },
  sortRow: { flexDirection: 'row', paddingHorizontal: spacing.lg, paddingBottom: spacing.md, gap: spacing.sm, direction: 'ltr' },
  ...
  row: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: borderRadius.lg, padding: spacing.md, marginBottom: spacing.sm, direction: 'ltr' },
  rank: { fontSize: 16, fontWeight: '700', color: colors.textSecondary, width: 36, textAlign: 'left' },
  rankTop: { color: colors.gold || colors.accent },
  infoCol: { flex: 1 },
  nickname: { color: colors.text, fontSize: 15, fontWeight: '600', marginBottom: 4, textAlign: 'left' },
  metricsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, direction: 'ltr' },
  metricText: { color: colors.textSecondary, fontSize: 12, textAlign: 'left' },
